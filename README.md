...
mdl v1.16.6, editor started. Open http://localhost:8080 in your browser.
```
...
The [mdl](https://pkg.go.dev/goa.design/model@v1.16.6/mdl?tab=doc) package
[RunDSL](https://pkg.go.dev/goa.design/model@v1.16.6/mdl?tab=doc#RunDSL)
method runs the DSL and produces data structures that contain all the
information needed to render the views it defines.

The [stz](https://pkg.go.dev/goa.design/model@v1.16.6/stz?tab=doc) package
[RunDSL](https://pkg.go.dev/goa.design/model@v1.16.6/stz?tab=doc#RunDSL)
...
The DSL package
[documentation](https://pkg.go.dev/goa.design/model@v1.16.6/dsl?tab=doc) lists
