...
[![DSL Reference](https://img.shields.io/badge/Doc-DSL-orange)](https://pkg.go.dev/goa.design/model@v1.0.3/dsl?tab=doc)
...
[package documentation](https://pkg.go.dev/goa.design/model@v1.0.3/dsl?tab=doc)
