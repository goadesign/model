...
The [mdl](https://pkg.go.dev/goa.design/model@v1.6.0/mdl?tab=doc) package
[RunDSL](https://pkg.go.dev/goa.design/model@v1.6.0/mdl?tab=doc#RunDSL)
...
The [stz](https://pkg.go.dev/goa.design/model@v1.6.0/stz?tab=doc) package
[RunDSL](https://pkg.go.dev/goa.design/model@v1.6.0/stz?tab=doc#RunDSL)
...
[RenderedView](https://pkg.go.dev/goa.design/model@v1.6.0/mdl?tab=doc#RenderedView).
