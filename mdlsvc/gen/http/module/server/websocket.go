...
//
// Module WebSocket server streaming
//
// Command:
...
// SubscribeServerStream implements the module.SubscribeServerStream interface.
...
// Send streams instances of "module.Model" to the "Subscribe" endpoint
// websocket connection.
func (s *SubscribeServerStream) Send(v module.Model) error {
	var err error
